...
import NavyLogoSvg from '@/assets/image/logo/ssure_logo_navy.svg?react';
...
// 65대 학생회 S:SURE 남색 버전입니다.

SsureLogo.Navy = ({ className }: React.SVGProps<SVGSVGElement>) => {
  return <NavyLogoSvg className={cn(className)} />;
};
