...

  {
    variants: {
      variant: {
        ...
        Register:
          'bg-[#2F4BF7] hover:bg-[#2F4BF7]/90 md:w-[105px] w-full h-10 text-white sm:text-lg text-xs text-center font-semibold rounded-[7px]',
        List_Edit:
        ...
        translate: 'w-[64px] bg-primary text-primary-foreground hover:bg-primary/90 h-full',
      },
      size: {
