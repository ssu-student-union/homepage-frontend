...
export function Category({ isActive = false, children, className = '', ...props }: CategoryProps) {
  return (
    <button
      className={cn(
        `flex h-[31px] min-w-fit items-center justify-center rounded-[32px] border px-[16px] py-[8px] text-[0.875rem] transition-colors duration-100 md:h-[38px] md:text-[1.125rem] ${
          isActive
