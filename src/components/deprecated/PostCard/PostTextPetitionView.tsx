import { ThumbsUp } from '@/components/deprecated/PostCard/const/icon';
...
const PostCardPetit = ({ title = '', subtitle = '', date, goodNumber = 0 }: PostCardPetitProps) => {
  return (
    <div
      className={`flex h-[9.75rem] w-[15.5rem] cursor-pointer flex-col items-center justify-between rounded-[0.62rem] border border-gray-300 bg-white px-[1.37rem] py-4 sm:h-[15.75rem] sm:w-[22.75rem] sm:rounded-[0.8rem] sm:px-7 sm:py-6`}
    >
