  ...
  return (
    <div className="flex gap-2">
      <Input
        ref={inputRef}
        type="text"
        className="border-[#959595] text-base placeholder:text-[#B6B6B6]  xs:h-[46px] xs:w-[211px] sm:h-[46px] sm:w-[211px] md:h-[58px] md:w-[488px] lg:h-[58px] lg:w-[254px] xl:h-[58px] xl:w-[488px] xxl:h-[58px] xxl:w-[488px]"
