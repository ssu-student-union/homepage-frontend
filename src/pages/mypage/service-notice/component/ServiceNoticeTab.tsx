...
export function ServiceNoticeTab({ Title }: ServiceNoticeTabProps) {
  ...
  return (
    <div className="fixed top-[60px] md:top-[50px] sm:top-[50px] xs:top-[48px] flex h-[64px] w-full animate-slideDown items-center justify-center gap-[8px] border-b-[1px] border-[#9CA3AF] bg-white z-50 pl-[10px] pr-[10px]">
      <Badge variant="Emergency" className="relative right-0 top-0">
        긴급
      </Badge>
      <div className="text-[18px] font-[700] ms:text-[14px] xs:text-[14px]">{Title}</div>
