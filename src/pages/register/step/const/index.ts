...
export const departments: DepartmentMap = {
  ...
  경제통상대학: ['국제무역학과', '금융경제학과', '글로벌통상학과', '통상산업학과', '경제학과'],
  경영대학: [
    '경영학부',
    '금융학부',
    '벤처경영학과',
  ...
  공과대학: ['건축학부', '기계공학부', '산업정보시스템공학과', '신소재공학과', '전기공학부', '화학공학과'],
  법과대학: ['국제법무학과', '법학과'],
  베어드학부대학: ['자유전공학부(인문)', '자유전공학부(자연)'],
  사회과학대학: ['사회복지학부', '언론홍보학과', '정치외교학과', '정보사회학과', '평생교육학과', '행정학부'],
  ...
  자연과학대학: ['물리학과', '수학과', '의생명시스템학부', '정보통계보험수리학과', '화학과'],
  차세대반도체학과: ['차세대반도체학과'],
};
